...
## Project Structure
    ...
    ├── sweet_snowflake_28994  # Django project configurations
...
1. Clone this repo and `cd sweet_snowflake_28994`
...
2. Clone this repo and `cd sweet_snowflake_28994`
